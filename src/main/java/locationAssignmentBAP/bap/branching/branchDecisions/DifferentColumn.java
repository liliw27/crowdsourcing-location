...
/**
 * Ensure that two vertices are put in different columns
 * @author Wang Li
 * @version 28-10-2022
 */
public final class DifferentColumn implements BranchingDecision<LocationAssignment, AssignmentColumn> {

    /** Vertices to be colored differently **/
    public final VertexPair<Customer> vertexPair;

    public DifferentColumn(VertexPair<Customer> vertexPair){
    ...
    public String toString(){
        return "DifferentColumn "+vertexPair;
    }
}
