 ...
 */
public class IncompatibleWorkerStation implements BranchingDecision<LocationAssignment, AssignmentColumn> {
    public final Worker worker;
    public final StationCandidate stationCandidate;
    public IncompatibleWorkerStation(Worker worker, StationCandidate stationCandidate){
        this.worker=worker;
    ...
    public boolean columnIsCompatibleWithBranchingDecision(AssignmentColumn column) {
        ...
        if(assignmentColumn_true.worker.equals(worker)&&assignmentColumn_true.stationCandidate.equals(stationCandidate)){
            return false;
        }
        return true;
    }
    ...
    public String toString(){
        return "IncompatibleWorkerStation worker: "+worker.getIndex()+", station: "+stationCandidate.getIndex();
    }
}
